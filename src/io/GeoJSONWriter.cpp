...
std::pair<double, double> GeoJSONWriter::convertCoordinate(const Coordinate* c) { return std::make_pair(c->x, c->y); }

std::vector<std::pair<double, double>> GeoJSONWriter::convertCoordinateSequence(
